...
file = File.read("woo-order-processing.json")
# file = File.read("woo-order-pending.json")
# data_hash = JSON.parse(file)
# response = HTTParty.post('https://indigosleep.herokuapp.com/api/v1/woo_orders', headers: headers, body: data_hash)
response = HTTParty.post('http://localhost:3000/api/v1/woo_orders.json', headers: headers, body: file)
